...
public class UnSortedTableMap<K,V> implements Map<K,V> {
    ...
    public boolean equalValues(MapEntry<K,V> m1, V value){
      if(m1.getValue().equals(value)){return true;}
      else return false;
    }
    // public methods
    /**
     ...
     * @return iterable collection of the map's entries
     */
    public boolean isSubMap(UnSortedTableMap map2){
        Iterator<Integer> itr = map2.keySet().iterator();
        for (MapEntry<K,V> a : table ){
            if(!(map2.containsKey(a.getKey()))){
                return false;}
            else if(!equalValues(a, (V) map2.get(a.getKey()))){
                return false;
            }}
        return true;
    }
    public static void main(String[] args){
        UnSortedTableMap<String,String> map1 = new UnSortedTableMap<>();
        map1.put("Smith","949-0504");
        map1.put("Marty","206-9024");
        UnSortedTableMap<String,String> map2=new UnSortedTableMap<>();
        map2.put("Marty","206-9024");
        map2.put("Smith","949-0504");
        map2.put("Hawking","123-4567");
        map2.put("Newton","123-4567");
        UnSortedTableMap<String,String> map3=new UnSortedTableMap<>();
        map3.put("Alisha","321-7654");
        map3.put("Hawking","123-4567");
        map3.put("Smith","888-8888");
        UnSortedTableMap<String,String> map4=new UnSortedTableMap<>();
       // map4.put("Smith","9786");
        System.out.println(map4.isSubMap(map3));
